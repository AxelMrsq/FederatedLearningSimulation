...
# first performance evaluation on client 1
client_1.client_evaluation(test_ds_client1_set1)


# first local iteration training on client 2
client_2.train_local_model(train_ds_client2_set1, val_ds_client2_set1)

# first performance evaluation on client 2
client_2.client_evaluation(test_ds_client2_set1)
...
# second performance evaluation on client 1
client_1.client_evaluation(test_ds_client2_set2)


# load the client1 model with the initial global weights
client_2.update_weights("./global_weights_iter/iter1.weights.h5")

# second performance evaluation on client 2
client_2.client_evaluation(test_ds_client2_set2)
